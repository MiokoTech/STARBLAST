package net.play5d.game.bvn.mob.ads.ctrl
{
   ...
   public class AdGroup extends EventDispatcher
   {
      ...
      public function initalize() : void
      {
         ...
         for each(var _loc1_:IAd in _adList)
         {
      ...
      private function testRate() : void
      {
         ...
         trace("------ RANK REPORT [ Count:" + _loc1_ + " ] ---------------------------------------------------------");
         for(var _loc9_:String in _loc13_)
         {
            trace(_loc9_ + "    -----------------------------------------------------------------");
            for(var _loc10_:String in _loc13_[_loc9_])
            {
               _loc5_ = int(_loc13_[_loc9_][_loc10_]);
               _loc12_ = _loc5_ / _loc1_ * 100;
      ...
      {
         var _loc5_:IAd = getRankAd("REWARD_VIDEO");
         if(!_loc5_)
         {
            return;
         }
      ...
      {
         for each(var _loc1_:IAd in _enabledAdList)
         {
            _loc1_.onGamePause();
         }
      }
